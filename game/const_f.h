...
#include <lgo/ver/.h>
#include <lgo/vec/s/d.h>

namespace constant {
    inline const lgo::ver current_version{ 0, 0, 0, 2, 1 };
    inline const lgo::ver last_necessary_version{ 0, 0, 0, 0, 1 };
    ...
    inline const lgo::svec<float, 3> message_text_color{ 0.0f, 0.0f, 0.0f };
